...
export default function ShopPage() {
    ...
    return (
        <div className="min-h-screen">
            {/* Hero */}
            <section className="relative py-20 overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-700 to-teal-600">
                {/* Image de fond discrète, cohérente avec le hero de l'accueil */}
